...
func main() {
	...
	http.HandleFunc("/users", enableCORS(userHandler))
	http.HandleFunc("/topics", enableCORS(topicHandler))
	http.HandleFunc("/posts", enableCORS(postHandler))
	http.HandleFunc("/comments", enableCORS(commentHandler))

	http.HandleFunc("/users/", enableCORS(handleGetUserByID))
	http.HandleFunc("/topics/", enableCORS(handleGetTopicByID))
	http.HandleFunc("/posts/", enableCORS(handleGetPostByID))
	http.HandleFunc("/comments/", enableCORS(handleGetCommentByID))
